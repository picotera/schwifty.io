...
goog.provide('cast.games.spellcast.gameobjects.ThreeSlice');
 ...
 */
cast.games.spellcast.gameobjects.ThreeSlice = function(frameName, maxWidth,
...
/** @override */
cast.games.spellcast.gameobjects.ThreeSlice.prototype.update =
    function(deltaTime) {
...
/** @override */
cast.games.spellcast.gameobjects.ThreeSlice.prototype.activate =
    function(position) {
