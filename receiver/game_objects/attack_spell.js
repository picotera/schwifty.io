...
goog.provide('cast.games.spellcast.gameobjects.AttackSpell');
 ...
 */
cast.games.spellcast.gameobjects.AttackSpell = function(frameName, numberFrames,
  ...
  /** @public {cast.games.spellcast.gameobjects.GameObject} */
...
/** @override */
cast.games.spellcast.gameobjects.AttackSpell.prototype.update =
    function(deltaTime) {
...
/** @override */
cast.games.spellcast.gameobjects.AttackSpell.prototype.activate =
    function(position, target, duration, spellEffect) {
  this.active = true;
