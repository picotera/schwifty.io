...
goog.provide('cast.games.spellcast.gameobjects.MovieEnemyAnimation');

goog.require('cast.games.spellcast.gameobjects.EnemyAnimation');
 ...
 * @constructor
 * @struct
 * @implements {cast.games.spellcast.gameobjects.EnemyAnimation}
 */
cast.games.spellcast.gameobjects.MovieEnemyAnimation = function(frameName,
...
/** @override */
cast.games.spellcast.gameobjects.MovieEnemyAnimation.prototype.activate =
    function() {
  this.active = true;
...
/** @override */
cast.games.spellcast.gameobjects.MovieEnemyAnimation.prototype.deactivate =
    function() {
  this.active = false;
  this.sprite.visible = false;
  this.sprite.stop();
...
/** @override */
cast.games.spellcast.gameobjects.MovieEnemyAnimation.prototype.update =
    function(deltaTime) {
