...
var initialize = function() {
  ...
  appConfig.statusText = 'Spellcast';
  appConfig.maxPlayers = cast.games.spellcast.GameConstants.MAX_PLAYERS;
  ...
  gameConfig.applicationName = 'Spellcast';
  /** @suppress {missingRequire} */
  var gameManager = new cast.receiver.games.GameManager(gameConfig);
  /** @suppress {missingRequire} */
  game = new cast.games.spellcast.SpellcastGame(gameManager);
